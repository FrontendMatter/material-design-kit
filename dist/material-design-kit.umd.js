(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('watch-object'), require('core-js/modules/es.array.for-each'), require('core-js/modules/es.regexp.exec'), require('core-js/modules/es.string.split'), require('core-js/modules/web.dom-collections.for-each'), require('@babel/runtime/helpers/typeof'), require('dom-factory'), require('core-js/modules/es.array.concat'), require('core-js/modules/es.array.map'), require('core-js/modules/es.function.name'), require('core-js/modules/es.string.fixed'), require('@babel/runtime/helpers/defineEnumerableProperties'), require('@babel/runtime/helpers/defineProperty'), require('retarget-mouse-scroll'), require('core-js/modules/es.number.to-fixed'), require('core-js/modules/es.array.filter'), require('core-js/modules/es.array.iterator'), require('core-js/modules/es.array.join'), require('core-js/modules/es.object.to-string'), require('core-js/modules/es.set'), require('core-js/modules/es.string.iterator'), require('core-js/modules/es.string.trim'), require('core-js/modules/web.dom-collections.iterator'), require('@babel/runtime/helpers/toConsumableArray'), require('core-js/modules/es.array.index-of'), require('core-js/modules/es.regexp.to-string'), require('core-js/modules/es.array.find'), require('core-js/modules/es.array.from'), require('core-js/modules/es.number.constructor'), require('core-js/modules/es.string.match')) :
  typeof define === 'function' && define.amd ? define(['exports', 'watch-object', 'core-js/modules/es.array.for-each', 'core-js/modules/es.regexp.exec', 'core-js/modules/es.string.split', 'core-js/modules/web.dom-collections.for-each', '@babel/runtime/helpers/typeof', 'dom-factory', 'core-js/modules/es.array.concat', 'core-js/modules/es.array.map', 'core-js/modules/es.function.name', 'core-js/modules/es.string.fixed', '@babel/runtime/helpers/defineEnumerableProperties', '@babel/runtime/helpers/defineProperty', 'retarget-mouse-scroll', 'core-js/modules/es.number.to-fixed', 'core-js/modules/es.array.filter', 'core-js/modules/es.array.iterator', 'core-js/modules/es.array.join', 'core-js/modules/es.object.to-string', 'core-js/modules/es.set', 'core-js/modules/es.string.iterator', 'core-js/modules/es.string.trim', 'core-js/modules/web.dom-collections.iterator', '@babel/runtime/helpers/toConsumableArray', 'core-js/modules/es.array.index-of', 'core-js/modules/es.regexp.to-string', 'core-js/modules/es.array.find', 'core-js/modules/es.array.from', 'core-js/modules/es.number.constructor', 'core-js/modules/es.string.match'], factory) :
  (global = global || self, factory(global.MDK = {}, global.watchObject, null, null, null, null, global._typeof, global.domFactory, null, null, null, null, global._defineEnumerableProperties, global._defineProperty, global.retargetMouseScroll, null, null, null, null, null, null, null, null, null, global._toConsumableArray));
}(this, (function (exports, watchObject, es_array_forEach, es_regexp_exec, es_string_split, web_domCollections_forEach, _typeof, domFactory, es_array_concat, es_array_map, es_function_name, es_string_fixed, _defineEnumerableProperties, _defineProperty, retargetMouseScroll, es_number_toFixed, es_array_filter, es_array_iterator, es_array_join, es_object_toString, es_set, es_string_iterator, es_string_trim, web_domCollections_iterator, _toConsumableArray) { 'use strict';

  _typeof = _typeof && Object.prototype.hasOwnProperty.call(_typeof, 'default') ? _typeof['default'] : _typeof;
  _defineEnumerableProperties = _defineEnumerableProperties && Object.prototype.hasOwnProperty.call(_defineEnumerableProperties, 'default') ? _defineEnumerableProperties['default'] : _defineEnumerableProperties;
  ...
  var scrollTargetBehavior = function scrollTargetBehavior() {
    return {
      ...
      detachFromScrollTarget: function detachFromScrollTarget() {
        watchObject.unwatch(this, 'scrollTargetSelector', this.attachToScrollTarget); // if (this.eventTarget) {
    ...
    return _ref = {
      ...
      _handleFixedPositionedScroll: function _handleFixedPositionedScroll() {
        ...
        if (this._isValidScrollTarget() && this._isPositionedFixedEmulated && this.scrollTarget !== this._doc && this.retargetMouseScroll) {
          this._fixedPositionedScrollHandler = retargetMouseScroll.RetargetMouseScroll(this.element, this.scrollTarget);
        }
      }
  ...
  var drawerLayoutComponent = function drawerLayoutComponent() {
    return {
      ...
      _resetPush: function _resetPush() {
        ...
        domFactory.util.transform("translate3d(".concat(transform, "px, 0, 0)"), contentContainer);
      },
