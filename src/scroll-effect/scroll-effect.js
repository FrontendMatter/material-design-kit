 ...
 */
export class ScrollEffectBehavior extends ScrollTargetBehavior {

	/**
	 * ScrollEffectBehavior constructor
	 ...
	 */
	constructor (element, scrollTarget, effects = [], effectsConfig = {}) {
		super(element, scrollTarget)
		...
		if (element.hasAttribute('effects-config')) {
			try {
				...
				console.warn(`Invalid [effects-config] value. Error: ${ e }`)
			}
		}
